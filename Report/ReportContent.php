    ...
    <div class="DivAllForm">
        ...
        <form action="ReportTraitement.php" class="Form" method="post">
            ...
            <div>
                ...
                <input type="url" class="demiInput" name="contentLink" placeholder="Lien du contenu à signaler" id="contentLink" required>
            </div>
            ...
            <div>
                ...
                <textarea class="demiInput" name="additionalDetails" placeholder="Ajoutez des détails supplémentaires (optionnel)" id="additionalDetails" rows="4"></textarea>
            </div>
