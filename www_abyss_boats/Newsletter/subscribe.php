...
$stmt = $pdo->prepare("INSERT INTO subscribers (email, confirmed, token, id_user) VALUES (:email, 0, :token, :id_user)");
$stmt->bindParam(':email', $email);
$stmt->bindParam(':token', $token);
$stmt->bindParam(':id_user', $user_id); // Ajout du paramètre id_user
$stmt->execute();
