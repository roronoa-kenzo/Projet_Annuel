        ...
        <body>
            ...
            <main class="container">
                <div class="black-frame">
                    <h1>Profil de <?php echo $user_username ?></h1>
                </div>
                    ...
                    <div class="white-content-admin">
                        <div class="post-container-admin">
                            <div class="iceberg-select">
                                ...
                                <p><strong>Administrateur :</strong> <?php echo $user_is_admin ? 'Oui' : 'Non' ?></p>
                                <p><strong>Banni :</strong> <?php echo $user_is_banned ? 'Oui' : 'Non' ?></p>
