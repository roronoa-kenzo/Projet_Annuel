        ...
        <div class="main-index-admin">
            ...
            <div class="white-content-admin">
                ...
                <a href="./UserInfo.php">
                    <div class="post-container-admin">
                        ...
                        <div class="iceberg-select">
                            <p>Nombre de user total: <?php echo $userCount ?></p>
                        </div>
                    </div>
                </a>
                <div class="post-container-admin">
                ...
                <a href="./ForumInfos.php">
                    <div class="post-container-admin">
                        <div class="iceberg-select">
                            <p>Nombre d'Iceberg : <?php echo $icebergCount ?></p>
                        </div>
                    </div>
                </a>
                ...
                <a href="./ReportPage.php">
                    <div class="post-container-admin">
                        <div class="iceberg-select">
                            <p>Nombre de Report à résoudre: <?php echo $totalPendingReports ?></p>
                        </div>
                    </div>
                </a>
                ...
                <a href="./Ticket_page.php">
                    <div class="post-container-admin">
                        <div class="iceberg-select">
                            <p>Nombre de Ticket à résoudre: <?php echo $tiketCount ?></p>
