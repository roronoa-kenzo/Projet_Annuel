    ...
    <nav class="navbar" role="navigation">
        ...
        <?php if (isset($_SESSION['email'])): ?>
            ...
            <div id="searchBar" class="search-container">
                <input type="text" class="inpuText" placeholder="Rechercher..." oninput="fetchRecherche(this.value)">
            ...
            <div class="nav_third">
                <form id="darkModeForm" method="POST">
                    ...
                    <button type="button" onclick="toggleDarkMode()" id="darkModeToggleButton">
                        <svg id="darkModeIcon" width="24" height="24" viewBox="0 0 24 24" fill="none"
        ...
        <div id="menuToggle">
            ...
            <ul id="menu">
                ...
                <?php include './../composants/xpBar.php'; ?>
                    ...
                    <div class="darkmode_svg" style="margin-right: 1em;">
                    <form id="darkModeForm" method="POST">
                            <input type="hidden" name="darkMode" id="darkModeInput"
                                value="<?php echo $darkMode ? 'on' : 'off'; ?>">
                            <button type="button" onclick="toggleDarkMode()" id="darkModeToggleButton">
                                <svg id="darkModeIcon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle class="sun" cx="12" cy="12" r="5" fill="currentColor"></circle>
                    ...
                    <?php 
                        ...
                        <div class="burger-navigation">
                        <h3>Add Iceberg</h3>
                        <button id="openModalButton" class="btn-menu">Créer un iceberg</button>
                            <h3>Your Iceberg</h3>
